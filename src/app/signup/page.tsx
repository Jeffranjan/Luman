  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div
          className="absolute top-1/3 right-1/3 h-[400px] w-[400px] rounded-full opacity-[0.1] blur-[120px]"
          style={{ background: "var(--accent)" }}
        />
        <div
          className="absolute bottom-1/3 left-1/3 h-[300px] w-[300px] rounded-full opacity-[0.08] blur-[100px]"
        ...
        >
          <div className="mb-8 text-center">
            ...
            <p className="text-sm" style={{ color: "var(--text-secondary)" }}>
              Start managing your inbox with AI
            </p>
          </div>
