  ...
  return (
    <div className="w-full max-w-sm space-y-6">
      ...
      <div className="space-y-3">
        <button
          className="flex w-full items-center justify-center gap-3 rounded-lg border border-white/20 bg-white/10 px-4 py-3 font-semibold text-white transition hover:bg-white/20 disabled:opacity-50"
      ...
      <form onSubmit={handleEmailAuth} className="space-y-3">
        {mode === "register" && (
          <input
            ...
            required
            className="w-full rounded-lg border border-white/20 bg-white/10 px-4 py-3 text-white placeholder:text-white/40 focus:border-purple-400 focus:ring-1 focus:ring-purple-400 focus:outline-none"
          />
        )}
        <input
          type="email"
